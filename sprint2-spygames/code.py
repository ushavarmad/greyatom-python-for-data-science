...
print("secret_msg_1 = {}".format(secret_msg_1))
...
print("message_3 = {}".format(message_3))

#Calling the function 'substitute_msg'
secret_msg_2 = substitute_msg(message_3) 

#Printing the secret message
print("secret_msg_2 = {}".format(secret_msg_2))
...
print("message_4 = {}".format(message_4))
print("message_5 = {}".format(message_5))
#Calling the function 'compare messages'
secret_msg_3 = compare_msg(message_4,message_5)

#Printing the secret message
print("secret_msg_3 = {}".format(secret_msg_3))
...
print("message_6 = {}".format(message_6))
...
#Printing the secret message
print("secret_msg_4 = {}".format(secret_msg_4))
...
print("secret_msg = {}".format(secret_msg))
